...
\begin{table}[bt!]
    ...
    \label{graphs}
\end{table}
The described algorithm in Section \numprint{4} was benchmarked by experiments and was compared to other partitioners. In this section, the experimental structure is explained first. Then, the results of those experiments will be presented. This chapter closes with ideas that could improve ~the ~algorithm.
